...
func init() {
	...
	resolveCmd.Flags().StringVar(&senderHandle, "sender-handle", "", chalk.Cyan.Color("Sender's paymail handle. Required by bsvalias spec. Receiver paymail used if not specified."))
