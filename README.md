...
```shell script
curl -LkSs https://github.com/mrz1836/paymail-inspector/releases/download/v0.4.2/paymail-inspector_macOS_64-bit.tar.gz -o app.tar.gz
...
uses [Go version 1.25.x](https://golang.org/doc/go1.25). View the [configuration file](.github/workflows/run-tests.yml).
